	...
	<div class="card">
		<div class="card-body">
			<form action="" id="manage_content">
				...
				<div class="row">
					<div class="col-md-6 form-group">
						<label for="" class="control-label">Document/File</label>
						<div class="custom-file">
						<input type="file" name="MAX_FILE_SIZE"value="16000000">
	                      <input type="file" class="custom-file-input" id="customFile" name="img" onchange="displayImg(this,$(this))">
	                      <label class="custom-file-label" for="customFile">Choose file</label>
	                    </div>
					</div>
				</div>
<!--/*<form action= "<?php echo $path ?>/action_page.php" method="post" enctype="multipart/form-data">
				...
				<div class="row">
					<div class="col-md-6 form-group">
						<div class="form-group d-flex justify-content-center align-items-center">
							<img src="<?php echo isset($banner_img) ? '../assets/uploads/'.$banner_img :'' ?>" id="cimg" class="img-fluid img-thumbnail ">
						</div>
					</div>
				</div>
				<div class="row">
